...
tabla_final_antiguo["AÑO"]=round(tabla_final_antiguo["PERIODO"]/100,0)
...
def tabla_corporativa_periodo(tabla_final):
    #########################################TABLA CORPORTATIVO periodo############
    periodos_seleccion=["202210","202220","202310","202320","202410","202420"]
    tabla_final=tabla_final[tabla_final["PERIODO"].isin(periodos_seleccion)]
    ...
    return tabla_corporativa_historica



def tabla_corporativa_año(tabla_final):
    #########################################TABLA CORPORTATIVO AÑO############
    periodos_seleccion=["202210","202220","202310","202320","202410","202420"]
    tabla_final=tabla_final[tabla_final["PERIODO"].isin(periodos_seleccion)]
    ...
    for periodo in periodos:
        ...
        tabla_auxiliar=tabla_final[tabla_final["AÑO"]==periodo]
    ...
    for periodo in periodos:
        ...
        tabla_auxiliar=tabla_final_antiguo[tabla_final_antiguo["AÑO"]==periodo]
        ...
        tabla_corporativa_historica_año=tabla_total_2016.merge(tabla_total,on="TIPO_HORARIO")
    return tabla_corporativa_historica_año



def tabla_sede_periodo(tabla_final,sede):
    #########################################TABLA SEDES: PROVIDENCIA periodo############
    periodos=["202210","202220","202310","202320","202410","202420"]
    sedes=sede
    ...
    return tabla_historica_providencia


def tabla_sede_año(tabla_final,sede):
    #########################################TABLA SEDES: PROVIDENCIA año############
    periodos_seleccion=["202210","202220","202310","202320","202410","202420"]
    tabla_final=tabla_final[tabla_final["PERIODO"].isin(periodos_seleccion)]
    periodos=["2022","2023","2024"]
    sedes=sede
    ...
    for periodo in periodos:
        ...
        tabla_historica_providencia_año=tabla_total_2016.merge(tabla_total_providencia,on="TIPO_HORARIO")
    
    
    return tabla_historica_providencia_año
...
def main():
    ...
    # st.dataframe(tabla_corporativa_periodo(tabla_final).style
    ...
    st.header('Resultados Corporativos')
    st.dataframe(tabla_corporativa_año(tabla_final).style
                 .format(precision=0, thousands=".", decimal=",")
    ...
    st.header('Resultados Providencia')
    st.dataframe(tabla_sede_año(tabla_final,"Providencia").style
                 .format(precision=0, thousands=".", decimal=",")
                 .background_gradient(cmap=colormap,subset=["2016","2017","2018","2019","2020","2021","2022","2023","2024"],axis=1)
                 ,hide_index=True)
    ...
    st.header('Resultados San Miguel')
    st.dataframe(tabla_sede_año(tabla_final,"San Miguel").style
                 .format(precision=0, thousands=".", decimal=",")
                 .background_gradient(cmap=colormap,subset=["2016","2017","2018","2019","2020","2021","2022","2023","2024"],axis=1)
                 ,hide_index=True)    
    ...
    st.header('Resultados Talca')
    st.dataframe(tabla_sede_año(tabla_final,"Talca").style
                 .format(precision=0, thousands=".", decimal=",")
                 .background_gradient(cmap=colormap,subset=["2016","2017","2018","2019","2020","2021","2022","2023","2024"],axis=1)
                 ,hide_index=True)
    ...
    st.header('Resultados Temuco')
    st.dataframe(tabla_sede_año(tabla_final,"Temuco").style
                 .format(precision=0, thousands=".", decimal=",")
                 .background_gradient(cmap=colormap,subset=["2016","2017","2018","2019","2020","2021","2022","2023","2024"],axis=1)
                 ,hide_index=True)
