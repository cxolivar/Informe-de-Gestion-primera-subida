...
################# BASE DE PRESUPUESTO################################
df_base_ppto=df_base[["UWVPRES_TERM_CODE","UWVPRES_CRN","UWVPRES_PROGRAMA","UWVPRES_NOMBRE_PROGRAMA","UWVPRES_TIPO_CURSO","UWVPRES_CAMPUS","UWVPRES_SUBJ_CODE","UWVPRES_CRSE_NUMB","UWVPRES_NOMBRE_CURSO","UWVPRES_HORAS","UWVPRES_VALOR","UWVPRES_SEMANAS","UWVPRES_GRADO_DOCENTE"]]
...
dist_horas=df_base_ppto.pivot_table(values=["TOTAL"],
                    index=["UWVPRES_TERM_CODE","UWVPRES_NOMBRE_PROGRAMA","UWVPRES_TIPO_CURSO","UWVPRES_CAMPUS","UWVPRES_GRADO_DOCENTE"],
                    aggfunc="sum")
...
def main():
    ...
    st.title('Distribución Grado Docente')
